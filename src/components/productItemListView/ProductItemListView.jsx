...
import "../productItemListView/productItemListView-styles.css";
  ...
  return (
    <div className="productItem shadow-md overflow-hidden rounded-md border-1 border-[rgba(0,0,0,0.1)] flex items-center">
      ...
      <div className="info p-3 py-5 px-8 w-[75%]">
        ...
        <h3 class="text-[18px] title mt-3 mb-3 font-[500] text-[rgba(0,0,0,0.9)]">
          <Link to="/" className="link">
            ALAWO Faux Leather Watch Box Organizer Case For Unisex With 12 Slots
            For Watches In And Cherry Color
          </Link>
        </h3>
        <p className="text-[14px] mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab, et aperiam. Nihil soluta cupiditate voluptas saepe alias. Eos aspernatur, provident modi a ipsam architecto hic obcaecati nesciunt, sed numquam itaque.
        </p>
        ...
        <div className="mt-3">
          <Button variant="contained" className="flex gap-2 items-center "> <IoCartOutline  className="text-[20px] font-[800]" /> Add to Cart</Button>
        </div>
      </div>
